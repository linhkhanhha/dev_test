...
// configuration step. It creates a namespace called `dev_test`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", dev_test::cmake::project_name, dev_test::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", dev_test::cmake::project_version);
      return EXIT_SUCCESS;
    }
